...
class CompetitivePlayerTests(unittest.TestCase):
    ...
    def test_complete_win(self):
        assert self.com_player.winning_play(0, 4) == 8
        assert self.com_player.winning_play(2, 4) == 6
        assert self.com_player.winning_play(0, 1) == 2
        assert self.com_player.winning_play(3, 4) == 5
        assert self.com_player.winning_play(6, 7) == 8
        assert self.com_player.winning_play(0, 3) == 6
        assert self.com_player.winning_play(1, 4) == 7
        assert self.com_player.winning_play(2, 5) == 8
